      ...
      <main>
        <section className="hero">
          <div className="hero-copy">
            ...
            <p>
              افحص مؤشرات بنية مشروعك وتبعياته وأسراره المكشوفة دون تعديل أي ملف
            </p>
        ...
        <section id="layers" className="layers-section">
          ...
          <div className="layers-rail">
            {[
              [Braces, "البنية", "تحليل المكونات وحدود المسؤوليات"],
              [ShieldCheck, "الأمان", "كشف الأسرار والأنماط غير الآمنة"],
